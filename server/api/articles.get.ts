  ...
  return [
    {
      ...
      content: "Dalam artikel ini, kita akan membahas cara mengorganisir kode Nuxt dengan struktur folder by domain. Pendekatan ini membantu dalam maintainability dan scalability aplikasi...",
    ...
    },
    {
      ...
      content: "Berikut adalah beberapa tips yang bisa membantu Anda dalam mengembangkan aplikasi Nuxt. Tips ini mencakup routing, fetch data, dan optimasi performance...",
    ...
    },
    {
      ...
      content: "Composition API adalah fitur baru di Vue 3 yang memberikan cara yang lebih fleksibel untuk mengorganisir logic komponen...",
